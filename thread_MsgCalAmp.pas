...
begin
   ...
   Try
      ...
      Begin
         ...
         TcpSrvForm.ThmsgCalAmp_ultimo := Now;
   ...
   Except
      ...
      SalvaLog(Arq_Log, 'ERRO - Thread Mensagem CalAmp - Encerrada por Erro: '
         + InttoStr(ThreadId));
      Encerrar := True;
      Self.Free;
...
Procedure msgCalAmp.BuscaMensagem;
Begin
...
Procedure msgCalAmp.EnviaMensagem;

Begin

   Try

      If Not TcpSrvForm.EnviamsgCalAmp(Mensagens) Then
...
Procedure msgCalAmp.AtualizaEnvio;
Var
   SqlExec: String;
Begin
...
Procedure msgCalAmp.Dormir(pTempo: Word);
Var
   Contador: Word;
