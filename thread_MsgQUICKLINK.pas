...
procedure msgQUICKLINK.Execute;
begin
...
Procedure msgQUICKLINK.BuscaMensagem;
Begin
...
Procedure msgQUICKLINK.EnviaMensagem;
...
Procedure msgQUICKLINK.AtualizaEnvio;
Var
   SqlExec: String;
Begin
...
Procedure msgQUICKLINK.Dormir(pTempo: Word);
Var
   Contador: Word;
