unit thread_gravacao_QUICKLINK;
...
Type
   ...
   Gravacao_QUICKLINK = class(TThread)
   public
...
procedure Gravacao_QUICKLINK.Execute;
begin
   Try
      ...
      Begin
         ...
         TcpSrvForm.ThGravacao_QUICKLINK_ultimo := Now;
...
Procedure Gravacao_QUICKLINK.BuscaArquivo;
Var
   Arquivos: TSearchRec;
Begin
   Try
...
Procedure Gravacao_QUICKLINK.GravaDatabase;
Var
   SqlExec: String;
   SqlPendente: String;
...
Function Gravacao_QUICKLINK.Decode(pPacket: String): String;
Var
   Strproc:   String;
   SqlTracking: String;
Begin
...
Function Gravacao_QUICKLINK.Decode_STT(pPacket: String): String;
Var
...
Begin
   ...
   Try
// começo da leitura e gravação dos pacotes do ET
        pPacket := pct_inteiro;
        StringProcessar(pPacket, Strproc, Separador);
...
//        if strtodate(Suntech_STT.C01_DATE) >  then
        ...
        //***** Comando  *ET,ID da Peça,SQ,0# 28/08/2014
...
Function Gravacao_QUICKLINK.Decode_ALT(pPacket: String): String;
Var
   Strproc:     String;
   SqlTracking: String;
   SqlAlerta:   String;
...
Function Gravacao_QUICKLINK.Decode_EMG(pPacket: String): String;
Var
   Strproc:     String;
   SqlTracking: String;
   SqlAlerta:   String;
...
Function Gravacao_QUICKLINK.Decode_CMD(pPacket: String): String;
Var
   PosInicio: Integer;
   PosFinal:  Integer;
   Strproc:   String;
...
Function Gravacao_QUICKLINK.Decode_Generico(pPacket,pTipo: String; pVetor: Array Of String ): String;
Var
   Strproc:    String;
   SqlParam:   String;
   SqlRetorno: String;
...
Procedure Gravacao_QUICKLINK.LimpaRecord();
Begin
...
Procedure Gravacao_QUICKLINK.Dormir(pTempo: Word);
Var
   Contador: Word;
