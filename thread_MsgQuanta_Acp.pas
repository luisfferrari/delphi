...
procedure MsgQuanta_acp.Execute;
begin
   ...
   Try
      ...
      Begin
         ...
         TcpSrvForm.ThMsgQuanta_Acp_ultimo := Now;
   ...
   Except
      ...
      SalvaLog(Arq_Log, 'ERRO - Thread Mensagem ACP - Encerrada por Erro: ' +
         InttoStr(ThreadId));
...
Procedure MsgQuanta_acp.BuscaMensagem;
Var
   blobR: TBlobField;
...
Procedure MsgQuanta_acp.EnviaMensagem;

Begin

   Try

      If Not TcpSrvForm.EnviaMsgquanta_acp(Mensagens) Then
...
Procedure MsgQuanta_acp.AtualizaEnvio;
Var
   SqlExec: String;
Begin
...
Function MsgQuanta_acp.Encode(pComando: String): Boolean;
Var
   StrTmp: String;
   StrTmp2: String;
   Comando: tCmdAcp245;
...
Procedure MsgQuanta_acp.Dormir(pTempo: Word);
Var
   Contador: Word;
