...
begin
   ...
   Except
      ...
      SalvaLog(Arq_Log, 'ERRO - Thread Mensagem WebTech - Encerrada por Erro: '
         + InttoStr(ThreadId));
      Encerrar := True;
      Self.Free;
...
Procedure msgWebTech.BuscaMensagem;
Begin
   ...
   try
      ...
      Qry.Close;
      Qry.Sql.Clear;
      Qry.Sql.Add('Select * from Nexsat.comandos_envio Where porta in (6001,7000,7001,7002,7003,7004) and status = 0;');
      Qry.Open;
...
Procedure msgWebTech.EnviaMensagem;
...
Procedure msgWebTech.AtualizaEnvio;
Var
   SqlExec: String;
Begin
...
Procedure msgWebTech.Dormir(pTempo: Word);
Var
   Contador: Word;
