...
Procedure msgSuntech.BuscaMensagem;
Begin
...
Procedure msgSuntech.EnviaMensagem;
...
Procedure msgSuntech.AtualizaEnvio;
Var
   SqlExec: String;
Begin
...
Procedure msgSuntech.Dormir(pTempo: Word);
Var
   Contador: Word;
